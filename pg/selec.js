...
export default class sels extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Container>
                <View>
                    <Header hasSegment style={{alignItems:'center', flexdirection: 'row', backgroundColor: '#800', justifyContent: 'space-evenly' }}>
                        ...
                        <Button transparent >
                            ...
                            <Text style={{ flex: 1 ,color:'white',fontSize:20,}}>لیست لغات مورد علاقه</Text>
                        

                    </Header>
                </View>
                <Segment style={{ backgroundColor: '#700' }}>

                    <Button first active={this.state.actfa} onPress={() => {
                        Alert.alert (this.state.fw[7])
                        this.setState({
                ...
                <Content padder>
                    ...
                    <List>
                    <ListItem thumbnail onPress={() => navigate('Det', {name: 'Jane'})}><Thumbnail source={require('../image/conceal.jpg')} />
